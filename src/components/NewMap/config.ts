...
export const MAPBOX = {
  params: {
    ...
    // mapStyle: "mapbox://styles/danilojr3/cjsunefnk3mej1fqdepgb9bwz",
    width: "100%",
    height: "100%",
    maxBounds: [
      [14.1650000001, 40.8350000001],
      [14.3000000001, 40.9000000001],
    ],
  },
  maxBounds: [
    [14.1650000001, 40.8350000001],
...
export const style = {
  ...
  sprite: "mapbox://sprites/danilojr3/cjsunefnk3mej1fqdepgb9bwz",
  glyphs: "mapbox://fonts/danilojr3/{fontstack}/{range}.pbf",
  layers: [
    {
      id: "background",
      type: "background",
    ...
    },
    {
      ...
      type: "fill",
      metadata: { "mapbox:group": "c00956cc0538f622e4e14b14b77fbec5" },
      source: "composite",
    ...
    },
    {
      ...
      paint: {
        ...
        "fill-opacity": ["interpolate", ["linear"], ["zoom"], 5, 0, 6, 0.4],
    ...
    },
    {
      id: "waterway",
      type: "line",
      metadata: { "mapbox:group": "6fe4ed93c99b75ab467510cc8cf75efc" },
      source: "composite",
    ...
    },
    {
      id: "barrier-line",
      type: "line",
      metadata: { "mapbox:group": "5bb89653e4834131def144b696525795" },
      source: "composite",
    ...
    },
    {
      ...
      type: "fill",
      metadata: { "mapbox:group": "d5c60c5c38766d26365c7e897e1456d3" },
      source: "composite",
    ...
    },
    {
      ...
      filter: [
        ...
        [
          "all",
          ["!in", "type", "crossing", "platform", "sidewalk", "steps"],
    ...
    },
    {
      id: "building-outline",
      type: "line",
      metadata: { "mapbox:group": "fff75a972a195db98c14f1c539b7fc14" },
      source: "composite",
      ...
      paint: {
        ...
        "line-width": ["interpolate", ["linear"], ["zoom"], 16, 2.75, 22, 6],
    ...
    },
    {
      id: "waterway-label",
      type: "symbol",
      metadata: { "mapbox:group": "1a437fbe7b67b45fe8edf393066a06be" },
      source: "composite",
    ...
    },
    {
      ...
      paint: { "text-color": "#5b86a9", "text-halo-width": 0 },
    },
    {
      id: "bridge-case",
      type: "line",
      metadata: { "mapbox:group": "eff3348ad17c3895e1cb4b1ee0050dac" },
      source: "composite",
      "source-layer": "road",
      filter: [
        "all",
    ...
    },
    {
      ...
      type: "line",
      metadata: { "mapbox:group": "dc5de21f01dde83c2f15fb26dc9aa3a5" },
      source: "composite",
      "source-layer": "admin",
      minzoom: 2,
    ...
    },
    {
      id: "road-label",
      type: "symbol",
      metadata: { "mapbox:group": "1160790f5c2cfce6e16b98566fe80556" },
      source: "composite",
    ...
    },
    {
      ...
      type: "symbol",
      metadata: { "mapbox:group": "955d6210c19b2bc4a81498e593cb0b01" },
      source: "composite",
    ...
    },
    {
      ...
      layout: {
        ...
        "text-font": [
          "literal",
          ["Roboto Mono Light", "Arial Unicode MS Regular"],
        ],
        "icon-size": 1,
        "text-anchor": "top",
        "text-field": ["coalesce", ["get", "name_en"], ["get", "name"]],
    ...
    },
    {
      ...
      layout: {
        ...
        "text-font": [
          ...
          [
            "step",
            ["get", "scalerank"],
            ["literal", ["Roboto Mono Medium", "Arial Unicode MS Bold"]],
            5,
            ["literal", ["Roboto Mono Regular", "Arial Unicode MS Regular"]],
          ],
        ],
      ...
      paint: {
        ...
        "icon-opacity": [
          ...
          0,
          5,
          ["match", ["get", "scalerank"], 0, 1, 1, 1, 2, 1, 3, 1, 0],
          6,
          1,
        ],
      },
    },
    {
      ...
      layout: {
        "text-field": ["coalesce", ["get", "name_en"], ["get", "name"]],
        "text-max-width": ["interpolate", ["linear"], ["zoom"], 0, 8, 3, 8],
        "text-font": [
          "literal",
          ["Roboto Mono Light Italic", "Arial Unicode MS Regular"],
        ],
        "text-size": [
          "interpolate",
          ["linear"],
          ["zoom"],
          2,
          ["step", ["get", "scalerank"], 12, 3, 10, 5, 8],
          9,
          ["step", ["get", "scalerank"], 32, 3, 24, 5, 19],
        ],
        "text-transform": "uppercase",
  ...
  created: "2019-03-04T17:58:33.183Z",
  id: "cjsunefnk3mej1fqdepgb9bwz",
  modified: "2019-03-04T17:58:33.183Z",
  owner: "danilojr3",
  visibility: "private",
  draft: false,
};
